...
// Device name
const char* nameOfPeripheral = "EdgeBCI";
...
// BLE Service
BLEService edgeBCIService(uuidOfService);
...
void setup() {
  ...
  BLE.setAdvertisedService(edgeBCIService);
  edgeBCIService.addCharacteristic(rxChar);
  edgeBCIService.addCharacteristic(txChar);
  BLE.addService(edgeBCIService);
